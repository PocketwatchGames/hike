...
public class WorldState
{
    ...
    // This world's terrain palette: the slot table every ChunkState.TerrainId byte
    ...
    // Never null; a world built without one gets TerrainPalette.Empty.
    public readonly TerrainPalette Terrains;
    ...
    public WorldState(Vector3I min, Vector3I max, SimData simData, TerrainPalette terrains = null)
    {
        Min = min;
        Max = max;
        SimData = simData;
